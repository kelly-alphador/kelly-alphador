...
- 🔭 Je travaille actuellement sur ArtistoSocial ArtistoSocial un projet personnel en cours de développement visant à créer une plateforme sociale innovante.
...
- 👯 Je cherche à collaborer **avec des développeurs frontend sur des projets .NET Core, pour créer ensemble des applications complètes, performantes et évolutives.**

- 🤝 Je cherche de l’aide pour **améliorer mes compétences en architecture backend et optimisation des performances API.**

- 💬 Demandez-moi à propos de **.NET Core, développement backend, ou optimisation d’API**
